...
subroutine sample_configs(temperature, XS, YS, n_therm, n_between, n_configs, out_unit)
    ...
    do c = 1, n_configs
        ...
        ! Write flat row of XS*YS int8 values (no record markers — stream access)
...
program run_sampler
    ...
    !── Temperature grid ─────────────────────────────────────────────────────────────
    ! Paper trains on T far from Tc (≈2.269):
    !   ordered     : T ∈ [1.0, 2.0]  (below Tc − 0.3)
    !   disordered  : T ∈ [2.5, 3.5]  (above Tc + 0.2)
    !   near Tc     : T ∈ [2.0, 2.5]  still sampled for test set
    ...
    !── Seed RNG (remove for non-reproducible runs) ─────────────────────────────────
